...
export function recordWalletStartupStage(stage: Stage) {
  if (process.env.EXPO_PUBLIC_STARTUP_TIMING !== 'true' || !started || recorded.has(stage)) return;
  recorded.add(stage);
